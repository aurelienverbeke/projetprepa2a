SCORE_COEFFICIENT_ENDURANCE = 100 #positif
...
SCORE_COEFFICIENT_ENDURANCE_ADVERSAIRES = 0 #negatif
SCORE_COEFFICIENT_ENDURANCE_ADVERSAIRE_VOISIN = 0 #endurance de l'adversaire qu'on peut taper #negatif
SCORE_ADVERSAIRE_VOISIN = 0 #le voisin peut nous taper #negatif
